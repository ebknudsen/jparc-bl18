...
### Set up mcrun line
mpirun ./$OUTFILE --dir $OUTDIR -n1e10 L_min=0.4 L_max=4 NX=101 NY=101 NZ=101 XW=0.01 YH=0.01 ZD=0.01 map_fn=default.map_101x101_rectified orts_fn=default.orts lau_fn=Fe.lau AX=2.886 AY=0 AZ=0 BX=0 BY=2.886 BZ=0 CX=0 CY=0 CZ=2.886 samplename=C0127 omega=54 runnumber=0 side=7
### END of McSub script
