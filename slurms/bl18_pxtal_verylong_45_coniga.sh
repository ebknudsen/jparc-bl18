...
### Set up mcrun line
mpirun ./$OUTFILE --dir $OUTDIR -n1e10 L_min=0.4 L_max=4 NX=1 NY=1 NZ=1 XW=0.01 YH=0.01 ZD=0.01 map_fn=1x1x3.map orts_fn=default.orts lau_fn=CoNiGa_bcc.xtal AX=2.86 AY=0 AZ=0 BX=0 BY=2.86 BZ=0 CX=0 CY=0 CZ=2.86 samplename=C0127 omega=45 runnumber=0 side=7
### END of McSub script
